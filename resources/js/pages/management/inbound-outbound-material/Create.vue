...
const submit = () => {
    form.post('/management/inbound-outbound-material', {
        preserveScroll: true,
    });
};
</script>
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <Head title="Tambah Inbound" />

        <div class="min-h-screen bg-muted/40 py-10">
            <div class="max-w-7xl mx-auto px-6 space-y-8">

                <div class="flex items-center justify-between">
                    <Heading variant="small" title="Tambah Inbound"
                        description="Tambahkan data inbound material baru." />
                    ...
                    <form @submit.prevent="submit" class="grid gap-6">
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                ...
                                {{ form.processing ? 'Menyimpan...' : 'Simpan Inbound' }}
                            </button>
                        </div>
