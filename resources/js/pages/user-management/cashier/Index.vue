        ...
        <div class="min-h-screen bg-muted/40 py-10">
            <div class="max-w-7xl mx-auto px-6 space-y-8">
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            <tr v-for="(user, index) in data.data" :key="user.id"
                                ...
                                <td class="px-6 py-4">
                                    <div v-if="user.cafe_cashiers && user.cafe_cashiers.length > 0" class="flex flex-wrap gap-1.5">
                ...
                <div class="rounded-2xl border bg-background shadow-sm p-6 space-y-4">
                    ...
                    <p class="text-sm text-muted-foreground">Cari user berdasarkan nama atau email untuk memberikan akses Cashier.</p>
